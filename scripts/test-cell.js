...
assert.strictEqual(metadata.starterUsage.cell.wxml, '<pui-cell title="组件标题" value="说明" arrow />', 'Cell Starter Usage 必须复制后立即展示完整条目');
assert(preview.includes('const starter = starterUsageByComponent[runtimeId];'), '官网基础引用必须读取共享 Starter Usage');
