...
assert(wxss.includes('.pui-tabbar--fixed.pui-tabbar--shape-normal { background: var(--pui-bg-page); }'), 'native fixed normal Tabbar continues the themed page canvas without becoming a Surface');
...
assert(previewStyles.includes('.pui-tabbar-preview.is-fixed.pui-tabbar-preview--shape-normal { background: var(--page); }'), 'H5 fixed normal Tabbar continues the themed page canvas without becoming a Surface');
