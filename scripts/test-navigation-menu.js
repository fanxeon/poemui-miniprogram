...
const presentation = create({
  ...
  panelWidth: 9999, maxHeight: -1, offset: 999, zIndex: 99999, duration: 999, easing: 'spring', reduceMotion: false,
});
...
assert(wxml.includes('wx:else\n            custom-class="pui-navigation-menu__header-action"') && wxml.includes('icon="chevron-left"') && wxml.includes('icon-only'), 'NavigationMenu submenu back must use a visible PUI circular IconButton');
