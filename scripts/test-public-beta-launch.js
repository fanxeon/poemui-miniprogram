...
assert(previewApp.includes('npm i poemui-miniprogram@0.1.0 -S --production'), '快速开始必须提供固定版本 npm 安装');
...
assert(readme.includes('当前公开版本为 `poemui-miniprogram@0.1.0`'), 'README 必须显式声明公共发布版本');
