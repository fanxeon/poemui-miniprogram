> **归档状态：已完成的 0.1.2 实施记录。** 当前组件约束以 `docs/components/BAR-CHART.md`、`WAFFLE.md`、`AREA-CHART.md`、`docs/H5_PREVIEW_COMPATIBILITY.md`、`docs/COMPONENT_RULES_INDEX.md` 与对应 Feedback Ledger 为准。
