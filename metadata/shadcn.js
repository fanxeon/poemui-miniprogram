...
const shadcnComponents = [
  ...
  ['Date Picker', 'date-time-picker', 'adapter', 'tap', 'DateTimePicker 直接组合 PUI Picker，提供年到秒精度、动态日期列、范围、步长、格式、值与显隐双受控、默认图标 Header / Classic 底部操作、Popup/内联和草稿确认；Calendar + Popover 继续承担可视月历与范围选择。', 'done'],
  ['Dialog', 'dialog', 'native', 'tap', '原生 Dialog 提供 17 Props、受控显隐、Header/Content/Footer 三区、八个具名 slot、按钮 actions、遮罩滚动保护与 close()。header-left 可承载一个紧凑图标按钮，请求状态由 content slot 组合 PUI Loading/Empty/Button 承担。', 'done'],
  ...
  ['Input', 'input', 'adapter', 'input', '原生 Input 提供 31 Props、受控/非受控文本、maxlength/maxcharacter、聚焦/常驻清空策略、常用微信键盘参数、三档尺寸/对齐、前后缀与 Icon、七类 slot、四类状态、清空/焦点/确认事件和固定 500ms/1ms 低动效。', 'done'],
