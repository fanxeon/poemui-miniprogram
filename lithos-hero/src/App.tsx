...
function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between p-4 sm:p-5">
      <a href="#" className="flex items-center gap-3" aria-label="Lithos home">
        <LithosLogo />
        ...
        {navItems.map((item, index) => (
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${
              index === 0 ? 'text-white' : 'text-white/80 hover:bg-white/20 hover:text-white'
            }`}
          >
            {item}
          </button>
      ...
      <button
        type="button"
        className="md:hidden inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/15 text-white backdrop-blur-md"
