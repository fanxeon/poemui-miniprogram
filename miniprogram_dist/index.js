...
require('./area-chart/area-chart');
require('./bar-chart/bar-chart');
require('./donut-chart/donut-chart');
require('./radar-chart/radar-chart');
require('./sortable-list/sortable-list');
require('./tour/tour');
require('./waffle/waffle');
